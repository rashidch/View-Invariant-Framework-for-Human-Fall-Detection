...
parser.add_argument("--cam", dest="inputvideo", help="video-name", default="examples/demo/test/Angle_F.mp4")
...
parser.add_argument(
    "--classifier", dest="classmodel", type=str, default="dnnnet", help="choose classifer model, defualt dnn model"
)
