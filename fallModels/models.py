...
class FallNet(nn.Module):
    def __init__(self, input_dim=34, class_num=2):
...
class GenNet(nn.Module):
    def __init__(self, Num):
        ...
        self.Enlstm = nn.LSTM(34, self.hidden_state, self.num_layers, batch_first=True, dropout=0.5)
        self.Delstm = nn.LSTM(self.hidden_state, 34, self.num_layers, batch_first=True, dropout=0.5)
