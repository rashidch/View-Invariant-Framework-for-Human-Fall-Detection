...
parser.add_argument('--save_out', type=str, default='outputs/dnn2d3d/56_Merge_Transform.avi',
                    help='Save display to video file.')
parser.add_argument('--cam', dest='inputvideo', help='video-name',
                    default='examples/demo/test/56_Merge.mp4')
parser.add_argument('--transform_file', dest='transfile', help='transformation-camera-file',
                    default='examples/transformation_file/5-FallingDown_3D_Original to taoyuan_angle1_3D_Original_transformationvalue.pickle')
