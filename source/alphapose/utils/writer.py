...
class DataWriter():
    ...
    def update(self):
        ...
        while True:
            ...
            (boxes, scores, ids, hm_data, cropped_boxes, orig_img, im_name, im_url) = self.wait_and_get(self.result_queue)
            #print('Image Name:', im_name, 'Image URL:', im_url)
            if orig_img is None:
    ...
    def save(self, boxes, scores, ids, hm_data, cropped_boxes, orig_img, im_name, im_url):
        # save next frame in the queue
        self.wait_and_put(self.result_queue, (boxes, scores, ids, hm_data, cropped_boxes, orig_img, im_name,im_url))
