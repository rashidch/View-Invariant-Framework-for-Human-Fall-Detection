...
from dataloader import SinglePose3dDataset
        ...
        for epoch in range(num_epochs):
            ...
            for phase in ['train', 'valid']:
                ...
                if phase== 'valid' and loss_>epoch_loss:
                    ...
                    conf_valid = conf_mat
                    #best_model_wts = copy.deepcopy(model.state_dict())
                    trainDNN.save_model(model, optimizer, loss_, epoch_acc, epoch_, save_path=r'checkpoints/dnntiny_3D_'+currTime)
...
if __name__ == '__main__':
    ...
    #train the model
    history, model, conf_train, conf_valid = trainDNN.train(DNN_model, dataloader3d, dataset3d_sizes, num_epochs=500)
